...
#    It listens on :8787 on all interfaces (CORS-enabled) so the dashboard's
#    JS can call it directly, no reverse proxy needed — whatever already
#    serves the static dashboard on :80 (e.g. simplehttpsrv) is untouched.
...
echo ""
echo "  NOTICE: orchestrator-api listens on 0.0.0.0:8787. If a firewall is"
echo "  active on this host, allow inbound TCP 8787 from wherever the"
echo "  dashboard is viewed from."
echo "=========================================================="
